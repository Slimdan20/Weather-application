...
const weatherDetils = document.querySelector(
    '.content-2 h1'
)
...
const weekDay =
    document.querySelectorAll('.main-1 p')
const temperature =
    document.querySelectorAll('.main-1 h2')
const temperature2 =
    document.querySelectorAll('.main-1 h3')
const temperatureImage =
    document.querySelectorAll('.main-1 img')
const correctDate = document.querySelector(
    '.content-1 h3'
)
    ...
    fetch(
        ...
        .catch((error) => {
            ...
            if (
                ...
                cityName.innerHTML = ''
                alert(
                    'Incorrect city entered. Displaying weather of default city!'
                )
                defaultWeather()
            } else {
                alert('an error occured')
        ...
        .then((data) => {
            ...
            for (
                ...
                temperature[i].innerHTML =
                    `<strong>Min:</strong> ${minTemp} °C`
                temperature2[i].innerHTML =
                    `<strong>Max:</strong> ${maxTemp} °C`
                if (
                    data.daily.weathercode[i] ===
                    0
                ) {
                    temperatureImage[i].src =
                        'image/clear.png'
                } else if (
                    data.daily.weathercode[i] ===
                        1 ||
